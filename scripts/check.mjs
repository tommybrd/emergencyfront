...
const tests = ['render-batching','forest-fire','pump-capacity','operational-depth','dispatch-pacing','signal-options','guard-features','parking-proximity','shift-briefing','ui-input','station-refill','noria','guard-life',
