...
La suite contrôle les ressources du site puis 44 scénarios : catalogue et répartitions, localisation des incidents, circulation, départs et retours de la flotte, victimes et transport au CH, sauvetage nautique, infirmier, lances et eau, profil du chef, domicile de nuit, renforts SPV, prochain appel, placement tactique et automobilistes qui libèrent le passage, annonces radio, balisage actif, traces de sinistres, dépannage routier, évacuation des occupants, coupure des énergies, lance sur nacelle, brancardage par EPA déblocage manuel à proximité, poteaux accessibles et victime occasionnelle dans un ascenseur.
