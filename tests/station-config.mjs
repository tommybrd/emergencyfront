...
const world=new T.Scene();for(const type of['VSAV','FPT','CCF','EPA']){const model=vehicle(world,type,undefined,{signalStyle:'round'});assert(model.userData.beacons.some(b=>b.geometry.type==='CylinderGeometry'));}
