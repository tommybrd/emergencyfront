...
const {state,engines,onCall,tickEngines,selectIncident,engageUnits,district}=await import('../dist/scene.js');
...
for(let i=0;i<2000&&pump.status!=='ready';i++)step();assert.equal(pump.status,'ready');
