...
| --- | --- | --- |
| G | Placement tactique guidé | Choix facultatif de positions repérées, déplacement réel de l’engin. |
| H | Circulation réactive | Les automobilistes se rangent, attendent le convoi puis se réinsèrent. |
...
| Lettre | Proposition |
| --- | --- |
| A | Sauvegarder et reprendre la même garde. |
| B | Départ conseillé, déclenchable en un clic, engagement manuel conservé. |
| C | Météo de garde : normal, chaleur, pluie, avec motifs adaptés. |
| D | Deux petits objectifs facultatifs de garde. |
| E | Rejouer exactement la même garde et comparer ses résultats. |
| F | Scènes plus expressives : victimes distinctes, porte ou étage repérable, pompage visible. La partie balisage est désormais couverte par J. |
| I-ancien | Couverture du secteur : repérer les zones moins bien couvertes et anticiper. Ancienne lettre I, distincte de la radio parlée approuvée dans la dernière liste. |
