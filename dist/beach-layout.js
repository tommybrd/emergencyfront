...
export const BEACH={
 ...
 parking:[{target:[120,-148.9],entry:[110,-152.9],approach:[115,-148.9],exit:[132,-152.9],yaw:Math.PI/2},
          {target:[120,-138.7],entry:[110,-152.9],approach:[115,-138.7],exit:[132,-152.9],yaw:Math.PI/2}]
};
