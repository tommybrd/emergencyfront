...
export function vehicle(parent,kind='FPT',color='#bd292b',options={}){
 const g=kind==='VSAV'&&options.ambulanceModel==='man'?manAmbulance(parent,options):kind==='FPT'||kind==='CCF'||kind==='EPA'||kind==='CCGC'?truckModel(parent,kind,color,options):vanModel(parent,kind,color,options);return g;
}
...
function manAmbulance(parent,options={}){
 ...
 box(g,2.12,.53,.18,yellow,0,.9,front+.025);box(g,1.4,.33,.05,black,0,1.3,front+.028);for(const y of[1.21,1.3,1.39])box(g,1.29,.018,.03,'#667276',0,y,front+.06);sign(g,'MAN',.42,.12,0,1.31,front+.082,black,'#e2e5dd');
