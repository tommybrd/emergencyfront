...
if(ambulance){box(g,width+.1,2.05,3.85,red,0,1.75,back+1.925);box(g,width+.18,.12,3.98,'#f3f1e2',0,2.84,back+1.925);box(g,.85,.2,.85,'#edeedf',0,3.02,back+2.7);ambulanceSides(g,w,back,red,fluoro);}
