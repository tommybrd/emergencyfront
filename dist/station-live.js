...
const signature=e=>JSON.stringify([modelKey(e),e.signalStyle||'standard',e.signalFront||e.signalStyle||'standard',e.signalRear||e.signalStyle||'standard',e.signalAmber||'standard',e.foamEnabled!==false,e.lightingEnabled!==false]);
